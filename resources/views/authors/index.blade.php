                    ...
                    <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                        ...
                        <tbody>
                            ...
                            <tr class="bg-white border-b dark:bg-gray-900 dark:border-gray-700">
                                <td class="py-4 px-4 font-medium text-gray-900 whitespace-nowrap dark:text-white">{{ $author->id }}</td>
                                <td class="py-4 px-4 font-medium text-gray-900 whitespace-nowrap dark:text-white">{{ $author->name }}</td>
